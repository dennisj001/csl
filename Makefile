...
SOURCES = src/basis/compiler/_compile.c src/basis/compiler/memory.c\
	...
	src/basis/core/dllist.c src/basis/core/interpret.c src/basis/core/lexer.c src/basis/core/cstack.c src/basis/core/classes.c src/basis/debug/debugOutput.c\
	...
	src/basis/core/compiler.c src/basis/core/finder.c src/basis/core/typedef.c\
	src/basis/interpreters.c src/basis/tabCompletion.c src/basis/colors.c src/basis/sourceCode.c src/basis/debug/debugStepping.c\
	...
	src/basis/debug/debuggerSteppingSetup.c src/basis/compiler/machineCode.c src/primitives/shell.c	src/primitives/kernel.c
#	src/primitives/ls9.c src/primitives/retro.c 
...
src/primitives/kernel.o  : src/primitives/kernel.c
	gcc -ggdb -fomit-frame-pointer -fno-unit-at-a-time -Itargets/c  -c -o src/primitives/kernel.o src/primitives/kernel.c
...
_install : 
	...
	-cp ./init.csl ./namespaces/test/sinit.csl
	-sudo rm csl.log
	...
	-sudo cp -r ../csl/src/primitives/lbForth* /usr/local/share
	-killall csl
