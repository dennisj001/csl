...
LO_Lambda ( ListObject * l0 )
{
    ...
    //ListObject *lambdaSignature = LO_First ( l0 ) ;
    Word * lambda = _LO_MakeLambda ( LO_Next ( l0 ) ) ;
...
LO_Set (ListObject * lfirst)
{
    ...
    for ( l1 = lfirst ; lsymbol = LO_Next ( l1 ) ; l1 = value )
    {
...
_LC_List ( LambdaCalculus * lc, ListObject * lfirst )
{
    ...
    {
        lnext = LO_Next ( l1 ) ;
        if ( l1->W_LispAttributes & ( LIST | LIST_NODE ) ) l1 = _LC_List ( lc, LO_First ( l1 ) ) ;
...
LO_List ( ListObject * lfirst )
{
    ...
    ListObject * l1 = _LC_List ( _LC_, LO_Next ( lfirst ) ) ;
    return l1 ;
}
...
{
    ListObject * l1 = LO_Next ( lfirst ) ;
    if ( l1->W_LispAttributes & ( LIST_NODE | LIST ) ) return LO_CopyOne ( LO_First ( l1 ) ) ; //( ListObject * ) l1 ;
...
{
    ListObject * l1 = LO_Next ( lfirst ) ;
    if ( l1->W_LispAttributes & ( LIST_NODE | LIST ) ) return LO_Next ( LO_First ( l1 ) ) ; //( ListObject * ) l1 ;
    return ( ListObject * ) LO_Next ( l1 ) ;
}
