...
int8 Array_Get_1_byte(byte *address, int64 size);
int16 Array_Get_2_bytes(byte *address, int64 size);
int32 Array_Get_4_bytes(byte *address, int64 size);
int64 Array_Get_8_bytes(byte *address, int64 size);
