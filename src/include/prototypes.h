...
void Compile_C_TypeDeclaration(Namespace *ns, byte *token);
...
void CSL_Prompt(CSL *csl, Boolean promptFlag);
...
CompileOptimizeInfo *COInfo_PushNew(Compiler *compiler);
CompileOptimizeInfo *COInfo_New(Compiler *compiler, uint64 type);
