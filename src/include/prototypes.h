...
void _Compile_GetCmpLogicFromTOS(BlockInfo *bi);
...
byte *_BI_Compile_Jcc_FlipBiN(BlockInfo *bi, byte *jmpToAddress);
byte *BI_Compile_Jcc_FlipN(BlockInfo *bi, byte *jmpToAddress, Boolean logicFlag);
byte *BI_Compile_JccFlipN(BlockInfo *bi, byte *jmpToAddress);
byte *Compiler_Compile_JccFlipN(Compiler *compiler, int64 bindex);
...
byte OffsetSize(byte insn);
byte InsnSize(byte insn);
...
int32 CalculateOffsetForCallOrJump(byte *insnAddr, byte *jmpToAddr, byte insnType);
...
BlockInfo *BlockInfo_GetCbsStackPick(int64 bindex);
...
int64 TD_Identifier_Or_Array_Field(int64 t_type);
...
void OVT_Throw(int signal, int64 restartCondition);
...
void OpenVmTil_Throw(byte *excptMessage, byte *specialMessage, int64 restartCondition, int64 infoFlag, int64 pauseFlag);
...
byte _OVT_SimpleFinal_Key_Pause(OpenVmTil *ovt, byte *msg);
...
void putkey(char chr);
void tell(const char *str);
cell jf_pop(void);
cell tos(void);
void jf_push(cell data);
dcell dpop(void);
...
void docol(void);
void doCellSize(void);
void memRead(void);
void memReadByte(void);
void key(void);
void jf_emit(void);
void drop(void);
void doExit(void);
...
void doBase(void);
void doState(void);
void gotoInterpreter(void);
void gotoCompiler(void);
void hide(void);
void rtos(void);
void stor(void);
void key_p(void);
...
void litstring(void);
void xor(void);
void timesDivide(void);
void timesDivideMod(void);
void dequals(void);
void dsmaller(void);
void dlarger(void);
void dusmaller(void);
...
void clrtrace(void);
int gottrace(void);
void report(char *s, int x);
void error(char *s, int x);
void expect(char *who, char *what, int got);
void fatal(char *s);
int readc(void);
void rejectc(int c);
void flush(void);
int l9_fwrite(char *s, int k);
...
void mark(int n);
int l9_gc(void);
int cons3(int pcar, int pcdr, int ptag);
void unmark_vecs(void);
int gcv(void);
int newvec(int type, int size);
int unprot(int k);
int mkstr(char *s, int k);
int mkvec(int k);
int mkport(int portno, int type);
int htsize(int n);
int mkht(int k);
unsigned int hash(unsigned char *s, unsigned int k);
unsigned int obhash(int x, unsigned int k);
int match(int a, int b);
void htgrow(int d);
int htlookup(int d, int k);
void htadd(int d, int k, int v);
int htrem(int d, int k);
int mksym(char *s, int k);
int findsym(char *s);
int intern(int y);
int symref(char *s);
int reconc(int n, int m);
int nreconc(int n, int m);
int conc(int a, int b);
int nconc(int a, int b);
int newport(void);
int open_inport(char *path);
int open_outport(char *path, int append);
int set_inport(int port);
int set_outport(int port);
void close_port(int port);
void reset_stdports(void);
int lock_port(int port);
int unlock_port(int port);
void bindnew(int v, int a);
int assq(int x, int a);
void bindset(int v, int a);
int octchar(char *s);
int strcmp_ci(char *s1, char *s2);
void rderror(char *s, int x);
int rdchar(void);
int rdlist(void);
int rdvec(void);
int pos(int p, char *s);
int scanfix(char *s, int r, int of);
int rdsymfix(int c, int r, int sym);
int rdfix(int c);
int rdstr(void);
int rdquote(int q);
int meta(void);
void ls9_doPrompt(void);
int xread2(void);
int xread(void);
char *ntoa(int x, int r);
void prchar(int sl, int x);
void prfix(int x);
void prstr(int sl, int x);
void prlist(int sl, int x, int d);
void prvec(int sl, int x, int d);
void prport(int out, int x);
void pruspec(int x);
void pruatom(int x);
void prquote(int sl, int x, int d);
void prex(int sl, int x, int d);
void xprint(int sl, int x);
void prin(int x);
void princ(int x);
void l9_print(int x);
int length(int n);
void ckargs(int x, int min, int max);
int ckseq(int x, int top);
int ckapply(int x);
int ckdef(int x, int top);
int ckif(int x);
int ckifstar(int x);
int symlistp(int x);
int memq(int x, int a);
int uniqlistp(int x);
int flatargs(int a);
int cklambda(int x);
int ckmacro(int x, int top);
int ckprog(int x, int top);
int ckquote(int x);
int cksetq(int x);
int syncheck(int x, int top);
int set_union(int a, int b);
int freevars(int x, int e);
int posq(int x, int a);
int initmap(int fv, int e, int a);
int lastpair(int x);
void newvar(int x);
void newvars(int x);
int mapconv(int x, int e, int a);
int lamconv(int x, int e, int a);
int contains(int a, int x);
int liftable(int x);
int liftnames(int m);
int liftargs(int m);
int appconv(int x, int e, int a);
int defconv(int x, int e, int a);
int cconv(int x, int e, int a);
int carof(int a);
int zipenv(int vs, int oe);
int clsconv(int x);
int obslot(void);
int obindex(int x);
void emit(int x);
...
int lsubr1(int x);
int subrp(int x);
void compprog(int x, int t);
void compsetq(int x);
void compif(int x, int t, int star);
void setupenv(int m);
int dottedp(int x);
void compcls(int x);
void compapply(int x, int t);
void compapp(int x, int t);
void compsubr0(int x, int op);
void compsubr1(int x, int op);
void compsubr2(int x, int op);
void compsubr3(int x, int op);
void composubr0(int x, int op);
void composubr1(int x, int op);
void complsubr0(int x, int op);
void compbitop(int x);
void complsubr1(int x, int op);
void compexpr(int x, int t);
int subprog(int x, int k);
int compile(int x);
void newmacro(int id, int fn);
int mapexp(int x, int r);
int zip(int a, int b);
int expandbody(int x);
int expanddef(int x);
int expand(int x, int r);
void fixover(char *who, int x, int y);
int add(int x, int y);
int xsub(int x, int y);
int mul(int x, int y);
int intdiv(int x, int y);
int intrem(int x, int y);
void grtr(int x, int y);
void gteq(int x, int y);
void less(int x, int y);
void lteq(int x, int y);
void equal(int x, int y);
int bitop(int x, int y, int o);
void cless(int x, int y);
void clteq(int x, int y);
void cequal(int x, int y);
void cgrtr(int x, int y);
void cgteq(int x, int y);
int scomp(int x, int y);
int memcmp_ci(char *a, char *b, int k);
int scomp_ci(int x, int y);
int sless(int x, int y);
int slteq(int x, int y);
int sequal(int x, int y);
int sgrtr(int x, int y);
int sgteq(int x, int y);
int siless(int x, int y);
int silteq(int x, int y);
int siequal(int x, int y);
int sigrtr(int x, int y);
int sigteq(int x, int y);
int b_mkstr(int x, int a);
int sconc(int x);
int sref(int s, int n);
void sset(int s, int n, int r);
int substr(int s, int n0, int n1);
void sfill(int x, int a);
int b_mkvec(int x, int a);
int vconc(int x);
int vref(int x, int n);
void vfill(int x, int a);
void vset(int v, int n, int r);
int subvec(int v, int n0, int n1);
int existsp(char *s);
int openfile(int x, int mode);
int b_readc(int p, int rej);
int b_read(int ps);
void b_prin(int x, int p, int sl);
int format(int x);
void b_writec(int c, int p);
...
int b_symname(int x);
int liststr(int x);
int listvec(int x, int veclit);
int strlist(int x);
int veclist(int x);
int numstr(int x, int r);
int strnum(char *s, int r);
...
void read_block(NgaState *vm);
void write_block(NgaState *vm);
void set_block_file(NgaState *vm);
void io_blocks(NgaState *vm);
void query_blocks(NgaState *vm);
int64 files_get_handle(NgaState *vm);
...
void init_core(NgaState *vm, int64 x);
void start_core(NgaState *vm, int64 x, int64 ip);
void pause_core(NgaState *vm, int64 x);
void resume_core(NgaState *vm, int64 x);
...
void scripting_include_plain(NgaState *vm);
...
void invalid_opcode(NgaState *vm, int64 opcode);
void execute(NgaState *vm, int64 cell);
...
void include_plain_file(NgaState *vm, char *fname, int run_tests);
void initialize(NgaState *vm);
void help(char *exename);
void register_devices(NgaState *vm);
void register_signal_handlers(void);
void _retro(void);
int64 stack_pop(NgaState *vm);
void stack_push(NgaState *vm, int64 value);
int64 string_inject(NgaState *vm, char *str, int64 buffer);
char *string_extract(NgaState *vm, int64 at);
void update_rx(NgaState *vm);
void register_device(NgaState *vm, void *handler, void *query);
void load_embedded_image(NgaState *vm);
int64 load_image(NgaState *vm, char *imageFile);
void prepare_vm(NgaState *vm);
void i_no(NgaState *vm);
void i_li(NgaState *vm);
void i_du(NgaState *vm);
void i_dr(NgaState *vm);
void i_sw(NgaState *vm);
void i_pu(NgaState *vm);
void i_po(NgaState *vm);
void i_ju(NgaState *vm);
void i_ca(NgaState *vm);
void i_cc(NgaState *vm);
void i_re(NgaState *vm);
void i_eq(NgaState *vm);
void i_ne(NgaState *vm);
void i_lt(NgaState *vm);
void i_gt(NgaState *vm);
void i_fe(NgaState *vm);
void i_st(NgaState *vm);
void i_ad(NgaState *vm);
void i_su(NgaState *vm);
void i_mu(NgaState *vm);
void i_di(NgaState *vm);
void i_an(NgaState *vm);
void i_or(NgaState *vm);
void i_xo(NgaState *vm);
void i_sh(NgaState *vm);
void i_zr(NgaState *vm);
void i_ha(NgaState *vm);
void i_ie(NgaState *vm);
void i_iq(NgaState *vm);
void i_ii(NgaState *vm);
void process_opcode(NgaState *vm, int64 opcode);
void validate_opcode_bundle(NgaState *vm, int64 opcode);
void verbose_details(NgaState *vm, int64 opcode);
