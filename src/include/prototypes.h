...
int64 Compiler_CheckOptimize(Compiler *compiler, int64 _specialReturn);
CompileOptimizeInfo *Compiler_GetWordStackState(Compiler *compiler, Word *word);
Word *Compiler_CheckForOpBetweenParentheses(CompileOptimizeInfo *optInfo, dlnode *snode);
Word *Compiler_Logic_CheckForOpBetweenParentheses(CompileOptimizeInfo *optInfo);
...
void Compiler_Optimizer_1Arg_W_RparenPrevOp(Compiler *compiler);
void Compiler_Optimizer_Cmp_2Args_With_Arg2Literal(Compiler *compiler);
void Compiler_Optimizer_2Args_With_Arg2Literal(Compiler *compiler);
int64 Compiler_Optimizer_2Args_CheckDo_Logic(Compiler *compiler);
...
Boolean Compile_X_OpEqual_Literal(Word *srcWord, block op, int8 mod, int8 rm, int64 disp);
void Compile_X_OpEqual(Compiler *compiler, block op);
int64 Compile_X_Literal(Word *dstWord, Word *literalWord, int lvalueSize, Boolean dstReg, Boolean srcReg, Word *codingWord);
void Compile_X_Equal(Compiler *compiler, int64 op, int lvalueSize);
void Compile_StandardArg(Word *word, Boolean reg, Boolean size, Boolean rvalueFlag, byte *setHere, Boolean setScaFlag);
