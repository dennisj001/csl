...
void _Debugger_COI_StepInto(Debugger *debugger, Word *word);
void Debugger_StepLoop(Debugger *debugger);
void Debugger_COI_StepKey(Debugger *debugger, Word *word);
void Debugger_DoJccType(Debugger *debugger, byte *jcAddress);
