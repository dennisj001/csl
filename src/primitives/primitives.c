...
CPrimitive CPrimitives [] = {
    ...
    { "define", 0, 0, 0, CSL_PP_Define, IMMEDIATE, 0, W_PREPROCESSOR, "PreProcessor", "Root" },
    { "include", 0, 0, 0, CSL_C_Include_PreProcessor, 0, 0, W_PREPROCESSOR, "PreProcessor", "Root" },
    ...
    { "_Printf", 0, 0, 0, ( block ) iPrintf, 0, 0, LISP_C_RTL_ARGS | T_LISP_SPECIAL | LISP_VOID_RETURN, "Lisp", "Root" },
    ...
    { "::", 0, 0, 0, ( block ) _LO_CSL, 0, T_LISP_CSL, T_LISP_SPECIAL | T_LISP_IMMEDIATE, "Lisp", "Root" },
    ...
    { "lcShowLisp", 0, 0, 0, ( block ) LC_Print_LispNamespace, 0, 0, 0, "Lisp", "Root" },
    ...
    { "->", 0, 0, 0, CSL_Dot, ( IMMEDIATE | M_POINTER ), 0, 0, "C", "Root" }, // for C copy and paste
    ...
    //{ "c_a9", 0, 0, 0, (block) C_a9, 0, 0, 0, "C", "Root" },
    ...
    { "countChangec", 0, 0, 0, CSL_CountChange, 0, 0, 0, "C", "Root" },
    //{ "CAnd", 0, 0, 0, CSL_TestAnd, 0, 0, 0, "C", "Root" },
    { "c_prefix", 0, 0, 0, CSL_C_Prefix, IMMEDIATE, 0, 0, "C", "Root" },
    //{ "cl0030", 0, 0, 0, cl0030, 0, 0, 0, "C", "Root" },
    ...
    { "!", 0, 0, TEST, CSL_LogicalNot, IMMEDIATE | LOGIC_OPT | PREFIX | CATEGORY_OP | CATEGORY_OP_1_ARG | CATEGORY_LOGIC | PREFIX | LOGIC_NEGATE, 0, 0, "C_Syntax", "C" },
    ...
    { "rpn", 0, 0, 0, CSL_PostfixModeOn, 0, 0, 0, "C_Syntax", "C" },
    ...
    { "while", 0, 0, 0, CSL_While_PrefixCombinators, KEYWORD | COMBINATOR | IMMEDIATE | BREAK_COMBINATOR | PREFIX_COMBINATOR, 0, 0, "PrefixCombinators", "C" },
    { "do", 0, 0, 0, CSL_DoWhile_PrefixCombinators, KEYWORD | COMBINATOR | IMMEDIATE | DO_BEFORE_CONTROL | BREAK_COMBINATOR | PREFIX_COMBINATOR, 0, 0, "PrefixCombinators", "C" },
    { "for", 0, 0, 0, CSL_For_PrefixCombinators, KEYWORD | COMBINATOR | IMMEDIATE | BREAK_COMBINATOR | PREFIX_COMBINATOR, 0, 0, "PrefixCombinators", "C" },
    { "loop", 0, 0, 0, CSL_Loop_PrefixCombinators, KEYWORD | COMBINATOR | IMMEDIATE | BREAK_COMBINATOR | PREFIX_COMBINATOR, 0, 0, "PrefixCombinators", "C" },
    ...
    { "while", 0, 0, 0, ( block ) CSL_WhileCombinator, COMBINATOR | IMMEDIATE | BREAK_COMBINATOR, 0, 0, "Combinators", "Root" },
    { "doWhile", 0, 0, 0, ( block ) CSL_DoWhileCombinator, COMBINATOR | IMMEDIATE | DO_BEFORE_CONTROL | BREAK_COMBINATOR, 0, 0, "Combinators", "Root" },
    //{ "doWhile", 0, 0, 0, ( block ) CSL_DoWhileCombinator, COMBINATOR | IMMEDIATE | BREAK_COMBINATOR, 0, 0, "Combinators", "Root" },
    { "doWhileDo", 0, 0, 0, CSL_DoWhileDoCombinator, COMBINATOR | IMMEDIATE | DO_BEFORE_CONTROL | BREAK_COMBINATOR, 0, 0, "Combinators", "Root" },
    ...
    { "loop", 0, 0, 0, CSL_LoopCombinator, COMBINATOR | IMMEDIATE | BREAK_COMBINATOR, 0, 0, "Combinators", "Root" },
    { "for", 0, 0, 0, CSL_ForCombinator, COMBINATOR | IMMEDIATE | BREAK_COMBINATOR, 0, 0, "Combinators", "Root" },
    ...
    { "setAllStateNotUsing", 0, 0, 0, CSL_SetAllNamespacesNotUsing, 0, 0, 0, "Namespace", "Root" },
    { "namespaces", 0, 0, 0, CSL_Namespaces, 0, 0, 0, "Namespace", "Root" },
    { "namespaces2", 0, 0, 0, CSL_NamespacesIndented, 0, 0, 0, "Namespace", "Root" },
    ...
    { "-", "NN.N", 0, 0, BigNum_Subtract, BIGNUM | CATEGORY_OP | INFIXABLE, 0, 0, "BigNum", "Class" },
    { "+=", "NN.N", 0, 0, BigNum_PlusEqual, INFIXABLE | CATEGORY_BIG_NUM_OP_OPEQUAL | BIGNUM | CATEGORY_OP, 0, 0, "BigNum", "Class" },
    { "*=", "NN.N", 0, 0, BigNum_MultiplyEqual, INFIXABLE | CATEGORY_BIG_NUM_OP_OPEQUAL | BIGNUM | CATEGORY_OP, 0, 0, "BigNum", "Class" },
    { "-=", "NN.N", 0, 0, BigNum_MinusEqual, INFIXABLE | CATEGORY_BIG_NUM_OP_OPEQUAL | BIGNUM | CATEGORY_OP, 0, 0, "BigNum", "Class" },
    { "/=", "NN.N", 0, 0, BigNum_DivideEqual, INFIXABLE | CATEGORY_BIG_NUM_OP_OPEQUAL | BIGNUM | CATEGORY_OP, 0, 0, "BigNum", "Class" },
    { "++", "N.N", 0, 0, BigNum_PlusPlus, BIGNUM | CATEGORY_OP, 0, 0, "BigNum", "Class" },
    { "--", "N.N", 0, 0, BigNum_MinusMinus, BIGNUM | CATEGORY_OP, 0, 0, "BigNum", "Class" },
    { "*", "NN.N", 0, 0, BigNum_Multiply, BIGNUM | CATEGORY_OP | INFIXABLE, 0, 0, "BigNum", "Class" },
    { "/", "NN.N", 0, 0, BigNum_Divide, BIGNUM | CATEGORY_OP | INFIXABLE, 0, 0, "BigNum", "Class" },
    //{ "==", "NN.B", 0, 0, ( block ) BigNum_Equal, INFIXABLE, 0, 0, "BigNum", "Class" },
    { "<=", "NN.B", 0, 0, ( block ) BigNum_LessThanOrEqual, BIGNUM | CATEGORY_OP | INFIXABLE, 0, 0, "BigNum", "Class" },
    { "<", "NN.B", 0, 0, ( block ) BigNum_LessThan, BIGNUM | CATEGORY_OP | INFIXABLE, 0, 0, "BigNum", "Class" },
    { ">=", "NN.B", 0, 0, ( block ) BigNum_GreaterThanOrEqual, BIGNUM | CATEGORY_OP | INFIXABLE, 0, 0, "BigNum", "Class" },
    { ">", "NN.B", 0, 0, ( block ) BigNum_GreaterThan, BIGNUM | CATEGORY_OP | INFIXABLE, 0, 0, "BigNum", "Class" },
    { "==", "NN.B", 0, 0, ( block ) BigNum_LogicalEquals, BIGNUM | CATEGORY_OP | INFIXABLE, 0, 0, "BigNum", "Class" },
    { "!=", "NN.B", 0, 0, ( block ) BigNum_LogicalDoesNotEqual, BIGNUM | CATEGORY_OP | INFIXABLE, 0, 0, "BigNum", "Class" },
    { "sqrt", "N.N", 0, 0, ( block ) BigNum_SquareRoot, 0, 0, 0, "BigNum", "Class" },
    { "pow", "NN.N", 0, 0, ( block ) BigNum_Power, BIGNUM | CATEGORY_OP | INFIXABLE, 0, 0, "BigNum", "Class" },
    { "^^", "NN.N", 0, 0, ( block ) BigNum_Power, BIGNUM | CATEGORY_OP | INFIXABLE, 0, 0, "BigNum", "Class" },
    { "**", "NN.N", 0, 0, ( block ) BigNum_Power, BIGNUM | CATEGORY_OP | INFIXABLE, 0, 0, "BigNum", "Class" },
    { "_beprint", 0, 0, 0, BigNum_EPrint, 0, 0, 0, "BigNum", "Class" },
    { "_bfprint", 0, 0, 0, BigNum_FPrint, 0, 0, 0, "BigNum", "Class" },

    { "not", 0, 0, TEST, CSL_LogicalNot, IMMEDIATE | LOGIC_OPT | KEYWORD | CATEGORY_OP | CATEGORY_OP_1_ARG | CATEGORY_LOGIC | LOGIC_NEGATE, 0, 0, "Logic", "Root" },
    { "!", 0, 0, TEST, CSL_LogicalNot, IMMEDIATE | LOGIC_OPT | KEYWORD | CATEGORY_OP | CATEGORY_OP_1_ARG | CATEGORY_LOGIC | LOGIC_NEGATE, 0, 0, "Logic", "Root" },
    { "&&", 0, 1, CMP, CSL_LogicalAnd, IMMEDIATE | LOGIC_OPT | KEYWORD | CATEGORY_OP | CATEGORY_OP_UNORDERED | CATEGORY_LOGIC | INFIXABLE, 0, 0, "Logic", "Root" },
    { "and", 0, 0, TEST, CSL_LogicalAnd, IMMEDIATE | LOGIC_OPT | KEYWORD | INFIXABLE | KEYWORD, 0, 0, "Logic", "Root" },
    { "||", 0, 1, OR, CSL_LogicalOr, IMMEDIATE | LOGIC_OPT | KEYWORD | CATEGORY_OP | CATEGORY_OP_UNORDERED | CATEGORY_LOGIC | INFIXABLE | KEYWORD, 0, 0, "Logic", "Root" },
    { "or", 0, 1, OR, CSL_LogicalOr, IMMEDIATE | LOGIC_OPT | KEYWORD | CATEGORY_OP | CATEGORY_OP_UNORDERED | CATEGORY_LOGIC | INFIXABLE | KEYWORD, 0, 0, "Logic", "Root" },
    { "xor", 0, 1, XOR, CSL_LogicalXor, IMMEDIATE | KEYWORD | CATEGORY_OP | CATEGORY_OP_UNORDERED | CATEGORY_LOGIC | INFIXABLE, 0, 0, "Logic", "Root" },
    { "^^", 0, 1, XOR, CSL_LogicalXor, IMMEDIATE | IMMEDIATE | KEYWORD | CATEGORY_OP | CATEGORY_OP_UNORDERED | CATEGORY_LOGIC | INFIXABLE, 0, 0, "Logic", "Root" },
    ...
    { "==", "II.B", 1, CMP, CSL_Logic_Equals, IMMEDIATE | KEYWORD | CATEGORY_OP | CATEGORY_OP_UNORDERED | CATEGORY_LOGIC | INFIXABLE, 0, 0, "Logic", "Root" },
    { "equal", "II.B", 1, CMP, CSL_Logic_Equals, IMMEDIATE | KEYWORD | CATEGORY_OP | CATEGORY_OP_UNORDERED | CATEGORY_LOGIC, 0, 0, "Logic", "Root" },
    { "!=", "II.B", 1, CMP, CSL_Logic_DoesNotEqual, IMMEDIATE | KEYWORD | CATEGORY_OP | CATEGORY_OP_UNORDERED | CATEGORY_LOGIC | INFIXABLE | LOGIC_NEGATE, 0, 0, "Logic", "Root" },
    ...
    { "**", "II.I", 0, 0, CSL_Power, IMMEDIATE | CATEGORY_OP_ORDERED | KEYWORD | CATEGORY_OP | INFIXABLE, 0, 0, "Int", "Root" },
    { "pow", "II.I", 0, 0, CSL_Power, IMMEDIATE | CATEGORY_OP_ORDERED | CATEGORY_OP | INFIXABLE | KEYWORD, 0, 0, "Int", "Root" },
    ...
    //{ "rem", 0, 3, MODULO, CSL_Remainder, IMMEDIATE | KEYWORD | CATEGORY_OP | CATEGORY_OP_DIVIDE | INFIXABLE | KEYWORD, 0, 0, "Int", "Root" },
    ...
    { "Strlen", 0, 0, 0, CSL_Strlen, PREFIXABLE, 0, 0, "String", "Root" },
    { "strcmp", 0, 0, 0, CSL_Strcmp, PREFIXABLE, 0, 0, "String", "Root" },
    { "strcat", 0, 0, 0, CSL_StrCat, PREFIXABLE, 0, 0, "String", "Root" },
    { "strcpy", 0, 0, 0, CSL_StrCpy, PREFIXABLE, 0, 0, "String", "Root" },
    ...
    { "cpbOn", 0, 0, 0, CSL_DebugOutputConcatOn, 0, 0, 0, "Io", "Root" },
    { "cpbOff", 0, 0, 0, CSL_DebugOutputConcatOff, 0, 0, 0, "Io", "Root" },
    { "dpbOn", 0, 0, 0, CSL_DebugOutputOn, 0, 0, 0, "Io", "Root" },
    ...
    { "stateAll", 0, 0, 0, CSL_SystemState_PrintAll, 0, 0, 0, "System", "Root" },
    ...
    { "ok", 0, 0, 0, Prompt, 0, 0, 0, "System", "Root" },
    { "prompt", 0, 0, 0, ( block ) Prompt, 0, 0, 0, "System", "Root" },
    ...
    { "debugOff", 0, 0, 0, CSL_DebugOff, DEBUG_WORD, 0, 0, "OpenVmTil", "Root" },
    { "debugOn", 0, 0, 0, CSL_DebugOn, DEBUG_WORD, 0, 0, "OpenVmTil", "Root" },
    { "debugLevel", 0, 0, 0, CSL_DebugLevel, IMMEDIATE, NAMESPACE_VARIABLE, 0, "OpenVmTil", "Root" },
    { "verbosity", 0, 0, 0, OpenVmTil_Verbosity, IMMEDIATE, NAMESPACE_VARIABLE, 0, "OpenVmTil", "Root" },
    { "dbi", 0, 0, 0, OpenVmTil_ShowMachineCodeInstructions, IMMEDIATE, NAMESPACE_VARIABLE, 0, "OpenVmTil", "Root" },
    ...
    { "historyDelete", 0, 0, 0, History_Delete, 0, 0, 0, "OpenVmTil", "Root" },
    ...
    { "includesOnlyOn", 0, 0, 0, CSL_PP_IncludeFileOnly_On, 0, 0, 0, "OpenVmTil", "Root" },
    ...
    //{ "freeLispTempSpace", 0, 0, 0, CSL_LC_Delete, 0, 0, 0, "Memory", "OpenVmTil" },
    { "freeLispSpace_All", 0, 0, 0, CSL_LC_Delete, 0, 0, 0, "Memory", "OpenVmTil" },
    { "freeLispSpace", 0, 0, 0, OVT_MemListFree_LispSpace, 0, 0, 0, "Memory", "OpenVmTil" },
    ...
    { "mem", 0, 0, 0, OVT_ShowMemoryAllocated, 0, 0, 0, "Memory", "OpenVmTil" },
    { "recycleDebugInfo", 0, 0, 0, OVT_RecycleAllWordsDebugInfo, 0, 0, 0, "Memory", "OpenVmTil" },
    //{ "memAllocated", 0, 0, 0, OVT_Mem_ShowAllocated, 0, 0, 0, "Memory", "OpenVmTil" },
    ...
    { "_interpret", 0, 0, 0, CSL_InterpreterRun, 0, 0, 0, "Interpreter", "Root" },
    ...
    //{ "value", 0, 0, 0, Word_Value, CATEGORY_OP_STACK, 0, 0, "Word", "Root" },
    { "valueEqual", 0, 0, 0, Word_ValueEqual, CATEGORY_OP_STACK, 0, 0, "Word", "Root" },
    { "value=", 0, 0, 0, Word_ValueEqual, CATEGORY_OP_STACK, 0, 0, "Word", "Root" },
    ...
    { "_endBlock", 0, 0, 0, CSL_EndBlock, BLOCK_DELIMITER, 0, 0, "Compiler", "Root" },
    { "beginBlock", 0, 0, 0, ( block ) CSL_BeginBlock, BLOCK_DELIMITER, 0, 0, "Compiler", "Root" },
    ...
    { "prefix", 0, 0, 0, CSL_Prefix, 0, 0, 0, "Compiler", "Root" },
    { "prefixable", 0, 0, 0, CSL_Prefixable, 0, 0, 0, "Compiler", "Root" },
    ...
    { "64@", 0, 0, MOV, CSL_Peek, IMMEDIATE | CATEGORY_OP | CATEGORY_OP_LOAD | CATEGORY_OP_1_ARG, 0, 0, "Compiler", "Root" }, // fetch
    { "8@", 0, WT_BYTE, MOV, CSL_8Peek, IMMEDIATE | CATEGORY_OP | CATEGORY_OP_LOAD | CATEGORY_OP_1_ARG, 0, 0, "Compiler", "Root" }, // fetch
    { "16@", 0, WT_WORD, MOV, CSL_16Peek, IMMEDIATE | CATEGORY_OP | CATEGORY_OP_LOAD | CATEGORY_OP_1_ARG, 0, 0, "Compiler", "Root" }, // fetch
    { "32@", 0, WT_LONG, MOV, CSL_32Peek, IMMEDIATE | CATEGORY_OP | CATEGORY_OP_LOAD | CATEGORY_OP_1_ARG, 0, 0, "Compiler", "Root" }, // fetch
    ...
    { "_peek", 0, 0, MOV, CSL_Peek, CATEGORY_OP | CATEGORY_OP_LOAD | CATEGORY_OP_1_ARG, 0, 0, "Compiler", "Root" },
    ...
    { "_poke", "XA.V", 0, MOV, CSL_Poke, CATEGORY_OP | CATEGORY_OP_EQUAL, 0, 0, "Compiler", "Root" },
    { "_set", "XA.V", 0, MOV, CSL_Poke, CATEGORY_OP | CATEGORY_OP_EQUAL, 0, 0, "Compiler", "Root" },
    ...
    { "Abs", 0, 0, 0, CSL_Abs, 0, 0, 0, "Compiler", "Root" },
    ...
    { "_compileWord", 0, 0, 0, Compile_A_CSLWord, 0, 0, 0, "Compiling", "Compiler" },
